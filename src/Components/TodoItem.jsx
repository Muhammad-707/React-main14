    ...
    return (
        <div className="relative bg-[#1A1A1A] border border-[#262626] rounded-[2rem] p-6 flex flex-col items-center text-center transition-all duration-300 hover:border-[#D48D71]/50 group">
            ...
            <div className="relative mb-4 mt-2">
                <div className="w-30 h-30 rounded-full overflow-hidden border-2 border-[#262626] group-hover:border-[#D48D71] transition-colors">
            ...
            <div className="space-y-2 w-full">
                ...
                <div className="pt-4">
                    <span className={`text-[9px] font-bold uppercase tracking-[0.15em] px-4 py-1.5 rounded-full border ${isDone
